...
/*SF_DATA;ver:1.26;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:3,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:False,rprd:True,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:False,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:2865,x:33294,y:32810,varname:node_2865,prsc:2|diff-6343-OUT,spec-358-OUT,gloss-1813-OUT,normal-5964-RGB,alpha-7736-A,refract-5941-OUT,voffset-9853-OUT;n:type:ShaderForge.SFN_Multiply,id:6343,x:32694,y:32608,varname:node_6343,prsc:2|A-7736-RGB,B-6665-RGB;n:type:ShaderForge.SFN_Color,id:6665,x:32368,y:32605,ptovrint:False,ptlb:Color,ptin:_Color,varname:_Color,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5019608,c2:0.5019608,c3:0.5019608,c4:1;n:type:ShaderForge.SFN_Tex2d,id:7736,x:32805,y:32409,ptovrint:True,ptlb:Base Color,ptin:_MainTex,varname:_MainTex,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:7b478f1d546f8d041ac464f53828cc66,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:5964,x:32683,y:32865,ptovrint:True,ptlb:Normal Map,ptin:_BumpMap,varname:_BumpMap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:3,isnm:True|UVIN-1072-UVOUT;n:type:ShaderForge.SFN_Slider,id:358,x:32135,y:32901,ptovrint:False,ptlb:Metallic,ptin:_Metallic,varname:node_358,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Slider,id:1813,x:32154,y:33025,ptovrint:False,ptlb:Gloss,ptin:_Gloss,varname:_Metallic_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.8,max:1;n:type:ShaderForge.SFN_Tex2d,id:2898,x:31829,y:33865,ptovrint:False,ptlb:Normal1,ptin:_Normal1,varname:node_9704,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:e216afe13bee3b544a5039b235044524,ntxv:3,isnm:True|UVIN-7346-UVOUT;n:type:ShaderForge.SFN_Panner,id:7346,x:31660,y:33865,varname:node_7346,prsc:2,spu:0,spv:-0.2|UVIN-9217-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:9217,x:31486,y:33865,varname:node_9217,prsc:2,uv:0;n:type:ShaderForge.SFN_Depth,id:9736,x:31511,y:34138,varname:node_9736,prsc:2;n:type:ShaderForge.SFN_OneMinus,id:2719,x:31713,y:34138,varname:node_2719,prsc:2|IN-9736-OUT;n:type:ShaderForge.SFN_Multiply,id:6063,x:31890,y:34087,varname:node_6063,prsc:2|A-2719-OUT,B-2503-OUT;n:type:ShaderForge.SFN_ComponentMask,id:1925,x:31991,y:33865,varname:node_1925,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-2898-RGB;n:type:ShaderForge.SFN_Fresnel,id:4095,x:32135,y:33515,varname:node_4095,prsc:2|EXP-2158-OUT;n:type:ShaderForge.SFN_Multiply,id:5941,x:32662,y:33722,varname:node_5941,prsc:2|A-3667-OUT,B-1965-OUT;n:type:ShaderForge.SFN_OneMinus,id:3667,x:32341,y:33575,varname:node_3667,prsc:2|IN-4095-OUT;n:type:ShaderForge.SFN_Multiply,id:1965,x:32274,y:33914,varname:node_1965,prsc:2|A-6063-OUT,B-1925-OUT;n:type:ShaderForge.SFN_TexCoord,id:7014,x:31864,y:33042,varname:node_7014,prsc:2,uv:0;n:type:ShaderForge.SFN_Panner,id:1072,x:32461,y:33126,varname:node_1072,prsc:2,spu:0.1,spv:0.1|UVIN-5368-UVOUT;n:type:ShaderForge.SFN_Multiply,id:5595,x:32642,y:33356,varname:node_5595,prsc:2|A-4132-OUT,B-8477-OUT,C-3265-OUT;n:type:ShaderForge.SFN_Multiply,id:9853,x:32860,y:33413,varname:node_9853,prsc:2|A-5595-OUT,B-4733-OUT;n:type:ShaderForge.SFN_Tex2d,id:7648,x:32661,y:33126,ptovrint:False,ptlb:Normal2,ptin:_Normal2,varname:node_7648,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:2,isnm:False|UVIN-1072-UVOUT;n:type:ShaderForge.SFN_Vector1,id:3265,x:32502,y:33483,varname:node_3265,prsc:2,v1:0.3;n:type:ShaderForge.SFN_ComponentMask,id:4132,x:32848,y:33100,varname:node_4132,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-7648-RGB;n:type:ShaderForge.SFN_NormalVector,id:8477,x:32407,y:33356,prsc:2,pt:True;n:type:ShaderForge.SFN_Vector1,id:2503,x:31713,y:34077,varname:node_2503,prsc:2,v1:1;n:type:ShaderForge.SFN_Vector1,id:4733,x:32792,y:33599,varname:node_4733,prsc:2,v1:0.1;n:type:ShaderForge.SFN_Vector1,id:2158,x:31992,y:33409,varname:node_2158,prsc:2,v1:0.001;n:type:ShaderForge.SFN_UVTile,id:5368,x:32185,y:33244,varname:node_5368,prsc:2|UVIN-7014-UVOUT,WDT-4352-OUT,HGT-5985-OUT,TILE-6308-OUT;n:type:ShaderForge.SFN_ValueProperty,id:5985,x:31929,y:33192,ptovrint:False,ptlb:hei,ptin:_hei,varname:node_5985,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0;n:type:ShaderForge.SFN_ValueProperty,id:4352,x:32005,y:33123,ptovrint:False,ptlb:wid,ptin:_wid,varname:node_4352,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0;n:type:ShaderForge.SFN_Vector1,id:6308,x:31978,y:33336,varname:node_6308,prsc:2,v1:2;proporder:5964-6665-7736-358-1813-2898-7648-5985-4352;pass:END;sub:END;*/
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_6844 = _Time + _TimeEditor;
                float node_6308 = 2.0;
                ...
                float2 node_1072 = (node_5368+node_6844.g*float2(0.1,0.1));
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_7346 = (i.uv0+node_6844.g*float2(0,-0.2));
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.tangentDir = normalize( mul( unity_ObjectToWorld, float4( v.tangent.xyz, 0.0 ) ).xyz );
                o.bitangentDir = normalize(cross(o.normalDir, o.tangentDir) * v.tangent.w);
                float4 node_7156 = _Time + _TimeEditor;
                float node_6308 = 2.0;
                float2 node_5368_tc_rcp = float2(1.0,1.0)/float2( _wid, _hei );
                float node_5368_ty = floor(node_6308 * node_5368_tc_rcp.x);
                float node_5368_tx = node_6308 - _wid * node_5368_ty;
                float2 node_5368 = (o.uv0 + float2(node_5368_tx, node_5368_ty)) * node_5368_tc_rcp;
                float2 node_1072 = (node_5368+node_7156.g*float2(0.1,0.1));
                float4 _Normal2_var = tex2Dlod(_Normal2,float4(TRANSFORM_TEX(node_1072, _Normal2),0.0,0));
                v.vertex.xyz += ((float3(_Normal2_var.rgb.rg,0.0)*v.normal*0.3)*0.1);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
                float3 lightColor = _LightColor0.rgb;
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalDirection = normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
                float partZ = max(0,i.projPos.z - _ProjectionParams.g);
                float2 node_7346 = (i.uv0+node_7156.g*float2(0,-0.2));
                float3 _Normal1_var = UnpackNormal(tex2D(_Normal1,TRANSFORM_TEX(node_7346, _Normal1)));
                float2 sceneUVs = float2(1,grabSign)*i.screenPos.xy*0.5+0.5 + ((1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),0.001))*(((1.0 - partZ)*1.0)*_Normal1_var.rgb.rg));
                float4 sceneColor = tex2D(_GrabTexture, sceneUVs);
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv2 = v.texcoord2;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_5230 = _Time + _TimeEditor;
                float node_6308 = 2.0;
                float2 node_5368_tc_rcp = float2(1.0,1.0)/float2( _wid, _hei );
                float node_5368_ty = floor(node_6308 * node_5368_tc_rcp.x);
                float node_5368_tx = node_6308 - _wid * node_5368_ty;
                float2 node_5368 = (o.uv0 + float2(node_5368_tx, node_5368_ty)) * node_5368_tc_rcp;
                float2 node_1072 = (node_5368+node_5230.g*float2(0.1,0.1));
                float4 _Normal2_var = tex2Dlod(_Normal2,float4(TRANSFORM_TEX(node_1072, _Normal2),0.0,0));
                v.vertex.xyz += ((float3(_Normal2_var.rgb.rg,0.0)*v.normal*0.3)*0.1);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
                o.pos = UnityObjectToClipPos(v.vertex );
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_5368_tx = node_6308 - _wid * node_5368_ty;
                float2 node_5368 = (o.uv0 + float2(node_5368_tx, node_5368_ty)) * node_5368_tc_rcp;
                float2 node_1072 = (node_5368+node_9730.g*float2(0.1,0.1));
                float4 _Normal2_var = tex2Dlod(_Normal2,float4(TRANSFORM_TEX(node_1072, _Normal2),0.0,0));
                v.vertex.xyz += ((float3(_Normal2_var.rgb.rg,0.0)*v.normal*0.3)*0.1);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
