...
public class DefaultOptionsScreen : OptionsScreen{
		...
		if (this.visible){
			if (this.musicToggle != null){
				...
				if (this.musicOn != null)
					musicOn.SetActive(this.musicToggle.isOn);
			}else{
				base.ToggleMusic();
			}
		}
		...
		if (this.visible){
			if (this.soundToggle != null){
				...
				if (this.soundOn != null)
					soundOn.SetActive(this.soundToggle.isOn);
			}
			else{
				base.ToggleSoundFX();
			}
	...
	public void AdcolonyInterstitalAd()
	{
	...
	public void UnityInterstitalAd()
	{
		AdsManager.GetInstance ().unityInterstitialAd.ShowInterstitial ();
	}
	public void UnityRewardedAd()
	{
		AdsManager.GetInstance ().unityRewardedAd.ShowRewardedAd ();
	}
	public void FacebookInterstitalAd()
	{
		//AdsManager.GetInstance ().facebookInterstialAd.ShowInterstitial ();
	}
	public void FacebookRewardedAd()
	{
		//AdsManager.GetInstance ().facebookRewardedAd.ShowRewardedVideo ();
	}
	public void ShowFacebookBanner()
	{
		//AdsManager.GetInstance ().facebookBanner.ShowAd ();
	}
	public void HideFacebookBanner()
	{
		//AdsManager.GetInstance ().facebookBanner.HideAd ();
	}

	public void ShowAdmobBanner()
	{
		AdsManager.GetInstance ().admobBanner.ShowBanner ();
	}
	...
	{
		AdsManager.GetInstance ().admobInterstitialAd.ShowInterstitial ();
	}
	public void ShowAdmobInterstitial_Static()
	{
		AdsManager.GetInstance().admobInterstitialAd.ShowInterstitial_Static();
	}
